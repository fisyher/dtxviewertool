...
export const loadDtxJsonIntoEngine = createAsyncThunk<CanvasChartState, {dtxJson: DTXJson, drawingOptions: DTXDrawingConfig}, {rejectValue: ErrorPayloadType}>(
  "canvas/loadDtxJson",
  async ({ dtxJson, drawingOptions }: { dtxJson: DTXJson; drawingOptions: DTXDrawingConfig }, {rejectWithValue}) => {
    try {
